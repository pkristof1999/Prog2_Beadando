...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tarolas = QtWidgets.QPushButton(self.centralwidget)
        self.tarolas.setGeometry(QtCore.QRect(180, 480, 151, 31))
        self.tarolas.setObjectName("tarolas")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tarolas.setText(_translate("MainWindow", "Értékek eltárolása"))
    
    def Configure(self):
        self.tarolas.clicked.connect(self.storeValues)
        self.szamolas.clicked.connect(self.readValues)
